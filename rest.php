<?php
    ...
    class Rest {
        ...
        public function __construct() {
            ...
            if ( 'buattoken' != strtolower($this->serviceName)) {
                $this->validateToken();
            }
        }
        ...
        public function validateRequest() {
            if ($_SERVER['CONTENT_TYPE'] != 'application/json') {
                ...
                'Request content type is not valid');
            }
        ...
        public function validateToken() {
            try {
                ...
                $stmt = $this->dbConn->
                    prepare("SELECT * FROM users WHERE user_id = :userId");
                ...
                if(!is_array($user)) {
                    ...
                    "This User not found in our database.");
                }
                if($user['is_active']==0) {
                    $this->returnResponse(USER_NOT_ACTIVE,
                    "This user may be deactivated. Please contact to admin.");
                }              
